...
namespace Tailviewer.BusinessLogic.DataSources
{
	...
	/// </summary>
	internal sealed class LogSourceCounter
		: ILogSourceListener
		, IDisposable
	{
		#region Counts
		...
		public LogSourceCounter()
		{
			...
			_buffers = new LogBufferList(GeneralColumns.LogEntryIndex, GeneralColumns.Timestamp, GeneralColumns.LogLevel);
			_emptyLine = new ReadOnlyLogEntry(new Dictionary<IColumnDescriptor, object>
			{
				{GeneralColumns.LogEntryIndex, new LogEntryIndex(-1) },
				{GeneralColumns.Timestamp, null },
				{GeneralColumns.LogLevel, LevelFlags.None}
			});
		}
