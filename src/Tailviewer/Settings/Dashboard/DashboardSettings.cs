...
namespace Tailviewer.Settings.Dashboard
{
	...
	public sealed class DashboardSettings
	{
		...
		private readonly List<ILogAnalyserConfiguration> _analysers;

		public DashboardSettings()
		{
			_layouts = new List<LayoutSettings>();
			_analysers = new List<ILogAnalyserConfiguration>();
		}

		public void Restore(XmlReader reader)
		{
			var layouts = new List<LayoutSettings>();
			var analysers = new List<ILogAnalyserConfiguration>();
			...
			foreach (ILogAnalyserConfiguration analyser in analysers)
			{
		...
		{
			foreach (ILogAnalyserConfiguration widget in _analysers)
			{
