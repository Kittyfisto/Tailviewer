...
namespace Tailviewer.AcceptanceTests.BusinessLogic.Sources.Text
{
		...
		: AbstractLogSourceTest
	{
		...
		{
			_source.Columns.Should().Equal(GeneralColumns.Minimum);
		...
		public void TestGetColumnTimestamp1()
		{
			...
			_source.GetProperty(GeneralProperties.LogEntryCount).Should().Be(2);
			_source.GetColumn(new LogFileSection(0, 2), GeneralColumns.Timestamp).Should().Equal(new object[]
			{
				new DateTime(2017, 12, 3, 11, 59, 30),
				new DateTime(2017, 12, 3, 12, 00, 00)
			});

			_source.GetColumn(new LogFileSection(1, 1), GeneralColumns.Timestamp)
		...
		public void TestGetColumnTimestamp2()
		{
			...
			_source.GetProperty(GeneralProperties.LogEntryCount).Should().Be(2);
			_source.GetColumn(new LogLineIndex[] {0,  1}, GeneralColumns.Timestamp).Should().Equal(new object[]
			{
				new DateTime(2017, 12, 3, 11, 59, 30),
				new DateTime(2017, 12, 3, 12, 00, 00)
			});
			_source.GetColumn(new LogLineIndex[] { 1, 0 }, GeneralColumns.Timestamp).Should().Equal(new object[]
			{
				new DateTime(2017, 12, 3, 12, 00, 00),
				new DateTime(2017, 12, 3, 11, 59, 30)
			});
			_source.GetColumn(new LogLineIndex[] { 1 }, GeneralColumns.Timestamp).Should().Equal(new object[]
			{
				new DateTime(2017, 12, 3, 12, 00, 00),
			});
		}
		...
		public void TestGetColumnTimestamp3()
		{
			...
			_source.GetColumn(new LogLineIndex[] { 1, 2 }, GeneralColumns.Timestamp).Should().Equal(new object[]
			{
				new DateTime(2017, 12, 3, 12, 00, 00),
				null
			});
			_source.GetColumn(new LogLineIndex[] { 1, 2, 0 }, GeneralColumns.Timestamp).Should().Equal(new object[]
			{
				new DateTime(2017, 12, 3, 12, 00, 00),
				null,
				new DateTime(2017, 12, 3, 11, 59, 30)
		...
		public void TestGetColumnDeltaTime1()
		{
			...
			_source.GetProperty(GeneralProperties.LogEntryCount).Should().Be(2);
			_source.GetColumn(new LogFileSection(0, 2), GeneralColumns.DeltaTime).Should().Equal(new object[]
			{
				null,
				TimeSpan.FromSeconds(30)
			});

			_source.GetColumn(new LogFileSection(1, 1), GeneralColumns.DeltaTime)
		...
		public void TestGetColumnDeltaTime2()
		{
			...
			_source.GetColumn(new LogFileSection(1, 5), GeneralColumns.DeltaTime).Should().Equal(new object[]
			{
				null,
				null,
				null,
