...
namespace Tailviewer.Archiver.Plugins
{
	...
	/// </remarks>
	/// <remarks>
	///     Plugin ids should NEVER start with 'Tailviewer.' as those plugins are automatically deleted whenever
	///     a new tailviewer version is installed. Plugins NOT starting with 'Tailviewer.' will not be touched during
	///     installation.
	/// </remarks>
	/// <example>
