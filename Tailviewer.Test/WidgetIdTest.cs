...
{
	[TestFixture]
	public sealed class WidgetIdTest
		: AbstractIdTest<WidgetId>
	{
		protected override WidgetId Empty()
		{
			return WidgetId.Empty;
		}

		protected override WidgetId CreateNew()
		{
			return WidgetId.CreateNew();
		}
